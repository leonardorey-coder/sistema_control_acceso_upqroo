...
{#if editPerson}
  <Modal open={editOpen} title="Editar persona" size="xl" onClose={() => (editOpen = false)}>
    <div class="edit-modal-stack">
      ...
      <section class="modal-side edit-credentials-section">
        ...
        <div class="edit-qr-footer">
          ...
          <QrPreview token={generatedToken} title={generatedTitle || "QR personal"} subtitle="El token solo se muestra al generar o rotar." autoOpen />
        </div>
      </section>
    </div>
  </Modal>
