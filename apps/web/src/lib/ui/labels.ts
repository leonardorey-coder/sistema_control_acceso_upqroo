...
export const adminActionLabels: Record<string, string> = {
  ...
  "config.admin_clients_updated": "Configuracion de navegadores admin actualizada",
  "admin_client.authorized": "Navegador admin autorizado",
  "admin_client.revoked": "Navegador admin revocado",
