  ...
  shareModal.innerHTML = `
    <div class="share-modal">
      ...
      <div class="share-modal-header">
        ...
        <p class="share-subtitle">Envia este codigo de acceso temporal</p>
      </div>

      <div class="share-modal-body">
        <div class="share-qr-preview">
          <img src="${qrImageDataUrl}" alt="QR Code" class="share-qr-image"/>
        </div>

        <div class="share-info-card">
          <div class="share-info-row">
            <span class="share-info-icon">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                <rect x="3" y="11" width="18" height="11" rx="2" ry="2"/>
                <path d="M7 11V7a5 5 0 0 1 10 0v4"/>
              </svg>
            </span>
            <span class="share-info-label">Codigo</span>
            <span class="share-info-value share-code-highlight">${codigo}</span>
          </div>
          <div class="share-info-row">
            <span class="share-info-icon">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <span class="share-info-label">Visitante</span>
            <span class="share-info-value">${visitante}</span>
          </div>
          <div class="share-info-row share-info-warning">
            <span class="share-info-icon">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                <circle cx="12" cy="12" r="10"/>
            ...
            <span class="share-info-label">Expira</span>
            <span class="share-info-value">${expira}</span>
          </div>
        </div>

        <div class="share-section-title">Enviar via</div>
        ...
        <div class="share-options">
          ...
          <button onclick="compartirSMS('${encodeURIComponent(mensaje)}')" class="share-btn sms">
            ...
            <span class="share-btn-text">SMS</span>
          </button>
        </div>

        <div class="share-divider">
          <span>o copia el codigo</span>
        </div>

        <button onclick="copiarCodigo('${codigo}')" class="share-copy-btn">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <rect x="9" y="9" width="13" height="13" rx="2" ry="2"/>
            <path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/>
          </svg>
          <span class="copy-code-text">${codigo}</span>
          <span class="copy-action">Copiar</span>
        </button>
      </div>
    </div>
  `;
